...
const l = () => {
  const [r, N] = a(!1), [s, M] = a(!1), [S, u] = a(0), [t, d] = a(), [i, I] = a(), [z, C] = a(), w = () => {
    const c = setInterval(() => {
      u((e) => e + 1);
    }, 1e3);
    I(c);
  ...
  return {
    startRecording: y(
      (c) => {
        i == null && (c ? (console.log(c), navigator.mediaDevices.getUserMedia({
          ...
          d(g), g.start(), w(), g.addEventListener("dataavailable", (o) => {
            C(o.data), g.stream.getTracks().forEach((L) => L.stop()), d(null);
          });
    ...
    stopRecording: () => {
      t == null || t.stop(), D(), u(0), N(!1), M(!1);
    },
    togglePauseResume: () => {
      s ? (M(!1), t == null || t.resume(), w()) : (M(!0), D(), t == null || t.pause());
    },
    recordingBlob: z,
    isRecording: r,
    isPaused: s,
...
const Q = ({
  ...
  return A(() => {
    ...
    className: `audio-recorder ${i ? "recording" : ""} ${(n = M == null ? void 0 : M.AudioRecorderClass) != null ? n : ""}`,
    ...
    src: k,
    className: `audio-recorder-options ${i ? "" : "display-none"} ${(o = M == null ? void 0 : M.AudioRecorderDiscardClass) != null ? o : ""}`,
    onClick: () => D(!1),
